...
class _PlannerState extends State<Planner> {
  ...
  Widget build(BuildContext context) {
    ...
    for(var v in boardsObj){
      String dataDia = "${_focusedDay.day}/${_focusedDay.month}/${_focusedDay.year}";
      print(dataDia);
          ...
          child: SizedBox(
            ...
            child: Container(
                ...
                child: Column(
                  ...
                  children: [Text(v.title), Text("Note: ${v.note}"), Text("Date: ${v.date}"), Text("Start: ${v.startTime}"), Text("End: ${v.endTime}")],
                )),
          ),
        ), onTap: () {
                      ...
                      content: SizedBox(
                        ...
                        //       style: TextStyle(fontSize: 13),
                            ...
                            TextField(
                                ...
                                decoration:
                                    InputDecoration(labelText: "Completed(1) or Not(0)"),
                                onChanged: (text) {},
                            )
                      ...
                      actions: [
                        ...
                        TextButton(
                            onPressed: () {
                              ...
                              Task t =
                                  Task(_controllerName.text, userID, boardID, _controllerNote.text, _controllerDate.text, _controllerStart.text, _controllerEnd.text, v.isCompleted);
                    ...
                    return AlertDialog(
                      ...
                      actions: [
                        ...
                        TextButton(
                            onPressed: () {
                              Task t =
                                  Task(_controllerName.text, userID, boardID, _controllerNote.text, _controllerDate.text, _controllerStart.text, _controllerEnd.text, 0);
